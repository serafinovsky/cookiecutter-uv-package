...
lint: ## Check code with linters
	...
	uv run ruff check cookiecutter_python_package/ --preview
	uv run ruff format hooks/
	uv run ruff format tests/
	uv run ruff format cookiecutter_python_package/
...
format: ## Format code
	...
	uv run ruff check cookiecutter_python_package/ --preview --fix
...
version: ## Show current version
	@make update-deps
	@uv run python -c "import cookiecutter_python_package; print(cookiecutter_python_package.__version__)"
